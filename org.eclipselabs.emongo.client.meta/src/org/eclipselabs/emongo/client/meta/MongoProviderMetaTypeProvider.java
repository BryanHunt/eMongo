...
package org.eclipselabs.emongo.client.meta;
 ...
 * 
 */
@Component(service = MetaTypeProvider.class, property = {"metatype.factory.pid=" + MongoProvider.PID})
public class MongoProviderMetaTypeProvider implements MetaTypeProvider
{
	@Override
    ...
    AttributeDefinitionImpl connectionsPerHost = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_CONNECTIONS_PER_HOST, "Connections Per Host", 1, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl connectTimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_CONNECT_TIMEOUT, "Connect Timeout", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl heartbeatConnectTimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_HEARTBEAT_CONNECT_TIMEOUT, "Heartbeat Connect Timeout", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl heartbeatFrequency = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_HEARTBEAT_FREQUENCY, "Heartbeat Frequency", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl heartbeatSocketTimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_HEARTBEAT_SOCKET_TIMEOUT, "Heartbeat Socket Timeout", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl localThreshold = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_LOCAL_THRESHOLD, "Local Threshold", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl maxConnectionIdleTime = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_MAX_CONNECTION_IDLE_TIME, "Max Connection Idle Time", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl maxConnectionLifeTime = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_MAX_CONNECTION_IDLE_TIME, "Max Connection Life Time", 0, Integer.MAX_VALUE);
    ...
    ocd.addOptionalAttribute(maxConnectionLifeTime);
		...
		AttributeDefinitionImpl maxWaitTime = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_MAX_WAIT_TIME, "Max Wait Time", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl minConnectionsPerHost = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_MIN_CONNECTIONS_PER_HOST, "Min Connections Per Host", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl minHeartbeatFrequency = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_MIN_HEARTBEAT_FREQUENCY, "Min Heartbeat Frequency", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl readPreferenceType = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_READ_PREFERENCE_TYPE, "Read Preference Type", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl serverSelectionTimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_SERVER_SELECTION_TIMEOUT, "Server Selection Timeout", 0, Integer.MAX_VALUE);
    ...
    ocd.addOptionalAttribute(socketKeepAlive);
		...
		AttributeDefinitionImpl socketTimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_SOCKET_TIMEOUT, "Socket Timeout", 0, Integer.MAX_VALUE);
    ...
    AttributeDefinitionImpl threadsAllowedToBlockForConnectionMultiplier = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_THREADS_ALLOWED_TO_BLOCK_FOR_CONNECTION_MULTIPLIER,
        "Blocked Threads Multiplier", 1, Integer.MAX_VALUE);
    ...
    ocd.addOptionalAttribute(threadsAllowedToBlockForConnectionMultiplier);
		...
		AttributeDefinitionImpl w = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_W, "Write Concern - w", 0, Integer.MAX_VALUE);
		...
		AttributeDefinitionImpl wtimeout = new IntegerAttributeDefinitionImpl(MongoProvider.PROP_WTIMEOUT, "Write Concern - wtimeout", 0, Integer.MAX_VALUE);
